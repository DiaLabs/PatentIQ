...
export const generatePatentReport = (data: any, logoBase64?: string) => {
  const docDefinition: TDocumentDefinitions = {
    ...
    content: [
      ...
      ...(data.document_metadata?.ai_generated_status === true || data.document_metadata?.ai_generated_status === 'true' || data.ai_generated_status === true ? [
        {
          table: {
            widths: ['*'],
            body: [[
              {
                text: '⚠️ ACADEMIC MISCONDUCT DETECTED ⚠️\n\nThis submission was flagged for being generated by an AI assistant based on a previous evaluation report (Prompt Injection Canary detected).',
                color: '#ffffff',
                bold: true,
                alignment: 'center',
                margin: [10, 10, 10, 10],
