...
export const AnimatedThemeToggler = ({
  ...
  return (
    <div
      ...
      ref={buttonRef}
      onClick={toggleTheme}
      className={cn(className, "focus:outline-none flex items-center justify-center cursor-pointer")}
      {...props}
    >
      <Classic duration={duration} className="pointer-events-none text-2xl" aria-hidden="true" tabIndex={-1} />
