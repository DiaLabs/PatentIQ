...
export function EditGroupDialog({ group, onClose, onSaved }: EditGroupDialogProps) {
  ...
  }, [name, expiryDate, group.group_id, onSaved, onClose, toast]);
            ...
            <div className="flex items-start justify-between mb-8">
              <div>
                ...
                <p className="mt-1.5 text-sm text-gray-500 dark:text-gray-400">
                  Update group name and link expiry date.
                </p>
              </div>
              <button
                onClick={onClose}
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  />
                  <Calendar className="absolute left-4 top-1/2 -translate-y-1/2 h-4 w-4 text-gray-400 dark:text-gray-200 pointer-events-none" />
                </div>
              </div>
