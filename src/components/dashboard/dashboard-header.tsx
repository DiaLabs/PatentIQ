              ...
              {showNotifications && (
                <>
                  ...
                  <motion.div
                    ...
                    className="absolute right-0 mt-3 w-80 bg-white dark:bg-zinc-900 rounded-2xl shadow-2xl border border-gray-100 dark:border-zinc-800 z-30 overflow-hidden"
                  >
